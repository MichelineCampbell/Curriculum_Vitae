...
use stalagmite proxy data to investigate past environments, which often
requires research into the modern environment and how that affects the
proxy system. My curent focus is on using stalagmite geochemistry to
research past fire events, but I also work in the climate-water security
sapce. I am currently a research fellow at the Max Planck Institute for
Chemistry in Mainz, Germany. I aim to secure a position which will allow
me to apply my laboratory and data science skillset to answer some of
the world's wicked questions and help policy-makers and land managers
plan for a changing world. Beyond my own research, I hope to find a
position where I can continue to support the development of the next
generation of earth and environmental scientists.
...
and in the field. Catchment and River Processes is a field-based course
which I taught into for my entire time at UWA, and which I
co-coordinated in 2018. \(~\)
...
Key funders include the Australian Institute of Nuclear Science and
Engineering (2 research awards), ANSTO (six synchrotron access
proposals), and UNSW (2 * competitive internal funding funding
\textasciitilde3 months salary and research costs). \(~\)
...
(Accepted)}, 1--19. \url{https://doi.org/10.5194/egusphere-2025-84}}
