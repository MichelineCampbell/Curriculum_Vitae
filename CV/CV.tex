...
\hypertarget{bibliography}{}
\leavevmode\vadjust pre{\hypertarget{ref-campbell_AINSE2}{}}%
\CSLLeftMargin{1. }%
\CSLRightInline{Barrington-Smith, G., \& Duncan, R. (2025). Historical
holes: Beneath the surface, caves hold the key to australia's wildfire
history. In \emph{AINSE 2025 Research Spotlight}.
...
\item Principal Component Analysis and similar methods%
\item Data wrangling%
\end{itemize}}
...
\item Cutting samples for U-Th dating%
\end{itemize}}
